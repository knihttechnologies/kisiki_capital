  ...
  return (
    <>
        ...
        <form className="container w-full mt-10 flex justify-center shadow-xl rounded-md " id='login' onSubmit={handleSubmit}>
          ...
          <h2 className="mb-9 mt-5 text-3xl font-bold text-slate-300 dark:text-white sm:text-title-xl2 text-center">
            Login
          </h2>
          <div className="mb-6">
            <label className="mb-2.5 block float-left font-medium text-slate-300 dark:text-white">
              Email
            </label>
