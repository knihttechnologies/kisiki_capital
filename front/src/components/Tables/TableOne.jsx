...
const TableOne = () => {
    ...
    let btnword = {
        tradingCurrency: [
            {indexNum: 1, icon: <CurrencyDollarIcon className="h-5 w-5 mt-1 ml-3" />, word: "USD"},
        ...
        acctBal: {
            acct1: {
                title: "USD",
                tc: [
                    {indexNum: 1, icon: <CurrencyDollarIcon className="h-5 w-5 mt-1 ml-3" />, word: 10000},
                    {indexNum: 2, icon: <CurrencyDollarIcon className="h-5 w-5 mt-1 ml-3" />, word: 25000},
                    {indexNum: 3, icon: <CurrencyDollarIcon className="h-5 w-5 mt-1 ml-3" />, word: 50000},
                    {indexNum: 4, icon: <CurrencyDollarIcon className="h-5 w-5 mt-1 ml-3" />, word: 100000},
                    {indexNum: 5, icon: <CurrencyDollarIcon className="h-5 w-5 mt-1 ml-3" />, word: 200000},
                ]
            },
            acct2: {
                title: "EUR",
    ...
    let icons = {
        usd: {
          currency: "USD",
          icon: <CurrencyDollarIcon className="h-7 w-7 mt-1 ml-3" />,
          values: [
    ...
    const handleSubmit = async (e) =>{
        ...
        try {
            ...
            // updateContext.setTableErr("The server has an issue")
        } catch (err) {
            //console.log(err)
    ...
    const klassInName = "w-20 bg-transparent text-white border-hidden focus:outline-none focus:border-none dark:border-hidden dark:text-white dark:bg-transparent"
    const klassBtnName = "w-30 bg-warning h-10 rounded-md border-hidden animate-pulse text-white focus:outline-none focus:border-none dark:border-hidden dark:text-white dark:bg-transparent"
  return (
    <div className="flex flex-col flex-wrap items-center">
        ...
        <div className="flex flex-row flex-wrap justify-center gap-5">
            <div className="rounded-md border border-stroke bg-black/100 px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                    ...
                    <tbody>
                        ...
                        <tr key={packageItem.name}>
                            ...
                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-md font-medium ${
                                    packageItem.info === 'Unlimited'
                                        ? 'bg-success text-success'
                                        : packageItem.info === 'limited'
                            ...
                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-md font-medium ${
                                    packageItem.infofund === 'Unlimited'
                                        ? 'bg-success text-success'
                                        : packageItem.infofund === 'limited'
                                        ? 'bg-danger text-danger'
                                        : 'bg-warning text-warning'
                                    }`}>
                                    {packageItem.infofund}
                                </p>
                            </td>
                        </tr>
                        ))}
            ...
            <div className='flex flex-col p-5'>
                ...
                /> */}
                <div className="mt-2 mb-10 flex flex-col  inline gap-6">
                    ...
                    <form onSubmit={handleSubmit}>
                        {updateContext.cardPrice == 10000 ? (
                            <>
                                <div className="flex flex-row mb-10 gap-4">
                                    {icons.usd.icon} 
                                    <input defaultValue={120} onChange={(e)=>{updateContext.setOrder(prev,{...prev, ['pkgprice']: e.target.value})}} name="pkgprice" className={klassInName} readOnly  />
                                    {/* <input value="One Phase Funding" onChange={(e)=>{updateContext.setOrder(prev,{...prev, ['pkgtitle']: e.target.value})}} type="hidden" name="pkgtitle" className={klassInName} />
                                    <input onChange={(e)=>{updateContext.setOrder(prev,{...prev, ['acctbal']: e.target.value})}} type="hidden" name="acctbal" className={klassInName} readOnly value="10,000"/> */}
                                </div>
                        ...
                        {updateContext.cardPrice == 25000 ? (
                            <>
                                <div className="flex flex-row mb-10 gap-4">
                                    {icons.usd.icon} 
                                    <input defaultValue={240} onChange={handleChange} name="pkgprice" className={klassInName} readOnly  />
                                </div>
                                <div className="mb-5 flex flex-col gap-2">
                                    <label className="mt-4 mb-2 text-white">Enter your email to receive login details</label>
                                    <input onChange={handleChange} name="useremail" className="p-3 w-70 bg-transparent border rounded-md shadow-xl text-slate-100 placholder:text-white " type="email" placeholder="Enter email" />
                        ...
                        {updateContext.cardPrice == 50000 ? (
                            <>
                                <div className="flex flex-row mb-10 gap-4">
                                    {icons.usd.icon} 
                                    <input defaultValue={320} onChange={handleChange} name="pkgprice" className={klassInName} readOnly  />
                                </div>
                                <div className="mb-5 flex flex-col gap-2">
                                    <label className="mt-4 mb-2 text-white">Enter your email to receive login details</label>
                                    <input onChange={handleChange} name="useremail" className="p-3 w-70 bg-transparent border rounded-md shadow-xl text-slate-100 placholder:text-white " type="email" placeholder="Enter email" />
                        ...
                        {updateContext.cardPrice == 100000 ? (
                            <>
                                <div className="flex flex-row mb-10 gap-4">
                                    {icons.usd.icon} 
                                    <input defaultValue={600} onChange={handleChange} name="pkgprice" className={klassInName} readOnly  />
                                </div>
                                <div className="mb-5 flex flex-col gap-2">
                                    <label className="mt-4 mb-2 text-white">Enter your email to receive login details</label>
                                    <input onChange={handleChange} name="useremail" className="p-3 w-70 bg-transparent border rounded-md shadow-xl text-slate-100 placholder:text-white " type="email" placeholder="Enter email" />
                        ...
                        {updateContext.cardPrice == 200000 ? (
                            <>
                                <div className="flex flex-row mb-10 gap-4">
                                    {icons.usd.icon} 
                                    <input defaultValue={1200} onChange={handleChange} name="pkgprice" className={klassInName} readOnly  />
                                </div>
                                <div className="mb-5 flex flex-col gap-2">
                                    <label className="mt-4 mb-2 text-white">Enter your email to receive login details</label>
                                    <input onChange={handleChange} name="useremail" className="p-3 w-70 bg-transparent border rounded-md shadow-xl text-slate-100 placholder:text-white " type="email" placeholder="Enter email" />
...
//     console.log(response)
//     if(response.status === 201){
//         updateContext.setTableMsg(response?.data?.objectToSend?.message)
//         updateContext.setOrder(response?.data?.objectToSend?.order)
//         //const orderId = updateContext.order.order_id
//         localStorage.setItem('order', response?.data?.objectToSend?.order)
...
//         updateContext.setTableErr(err?.response?.data?.message)
//         auth.setOpenSignIn(!auth.openSignIn)
//         return updateContext.setTableModal(!updateContext.tableModal)  
//     }
//     if(err.response.status === 500) return updateContext.setTableErr(err?.response?.data?.message)
//     // updateContext.setTableErr("The server has an issue")
// })
